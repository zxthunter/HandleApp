...
public class TrainPlanDB extends Model {
    @Column(name = "uid")
    private String uid;
    ...
    public TrainPlanDB(String uid, String instName, String name, String qualification, String assessmentNature, String certificateType, String companyType, String workClass, String workItem, String year, String stage, String trainLimit, String trainAddress, String trainBeginDate, String trainEndDate, String trainHours, String about, String contact, String telephone, String curriculums) {
        this.uid = uid;
    ...
    public TrainPlanDB(TrainPlan trainPlan) {
        this.uid = trainPlan.getUid();
        this.instName = trainPlan.getInstName();
        this.name = trainPlan.getName();
        this.qualification = trainPlan.getQualification();
        this.assessmentNature = trainPlan.getAssessmentNature();
        this.certificateType = trainPlan.getCertificateType();
        this.companyType = trainPlan.getCompanyType();
        this.workClass = trainPlan.getWorkClass();
        this.workItem = trainPlan.getWorkItem();
        this.year = trainPlan.getYear();
        this.stage = trainPlan.getStage();
        this.trainLimit = trainPlan.getTrainLimit();
        this.trainAddress = trainPlan.getTrainAddress();
        this.trainBeginDate = trainPlan.getTrainBeginDate();
        this.trainEndDate = trainPlan.getTrainEndDate();
        this.trainHours = trainPlan.getTrainHours();
        this.about = trainPlan.getAbout();
        this.contact = trainPlan.getContact();
        this.telephone = trainPlan.getTelephone();
        this.curriculums = new Gson().toJson(trainPlan.getCurriculums());
    }
}
